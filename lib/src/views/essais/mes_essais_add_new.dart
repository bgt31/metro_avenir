...
class MesEssaisAddNew extends StatefulWidget {
  MesEssaisAddNew({Key key}) : super(key: key);
...
class _MesEssaisAddNewState extends State<MesEssaisAddNew> {
  ...
  final List<String> names = ['Maxime RUMPLER', 'Vincent MOUREAU'];
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(flex: 1, child: Text('Congés'))
                        ],
                      ),
                      SizedBox(
                        height: 24.0,
                      ...
                      ListTile(
                        title: GestureDetector(
                          ...
                          onTap: () {
                            setState(() {
                              _creerAffecterEssai =
                                  CreerAffecterEssai.essaiExistant;
                              showEssai = true;
                          ...
                          child: Column(
                            children: [
                              ...
                              ListTile(
                                title: GestureDetector(
                                  child:
                                      const Text('Nuit longue (21h30 - 5h30)'),
                                  onTap: () {
                                    setState(() {
                                      _typeCreneau = TypeCreneau.nuitLongue;
                                    });
                                  },
                                ),
                              ...
                              ListTile(
                                title: GestureDetector(
                                  ...
                                  onTap: () {
                                    setState(() {
                                      _typeCreneau = TypeCreneau.nuitProlongee;
                                    });
                                  },
                                ),
                                leading: Radio<TypeCreneau>(
                              ...
                              ListTile(
                                title: GestureDetector(
                                  child:
                                      const Text('Nuit courte (22h00 - 6h00)'),
                                  onTap: () {
                                    setState(() {
                                      _typeCreneau = TypeCreneau.nuitCourte;
                                    });
                                  },
                                ),
                                leading: Radio<TypeCreneau>(
                              ...
                              ListTile(
                                title: GestureDetector(
                                  child: const Text('Jour (9h00 - 18h00)'),
                                  onTap: () {
                                    setState(() {
                                      _typeCreneau = TypeCreneau.jour;
                                    });
                                  },
                                ),
                                leading: Radio<TypeCreneau>(
